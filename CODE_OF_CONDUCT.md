...
This Code of Conduct applies within all project spaces — issues, pull requests, code review, internal Slack/Teams threads, and any public communication that references the project. It also applies when an individual is officially representing the project in public spaces.
